...
export class MenuView extends React.Component {
    render() {        
        return (
            <Menu anchorCorner={this.props.anchorCorner} open={this.props.open} onSelect={this.props.onSelect} onClose={this.props.onClose} onMouseLeave={(this.props.cascading ? this.props.onClose : () => {return;})}>
