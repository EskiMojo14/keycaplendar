            ...
            <Card>
                <List twoLine>
                    {this.props.sets.map((set, index) => {
                        ...
                        return (
                            <ElementCompact page={this.props.page} selected={(this.props.detailSet === set || this.props.editSet === set)} set={set} title={title} subtitle={subtitle} image={set.image} details={this.props.details} closeDetails={this.props.closeDetails} link={set.details} live={live} key={index} />
                        )
                    })}
                </List>
            </Card>
