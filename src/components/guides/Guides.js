      ...
      <div className="guide-container">
        <Card className="guide">
          ...
          <Typography use="caption" tag="p" className="secondary">
            Please note that entries in KeycapLendar should have existing public ICs; ideally on Geekhack, Keebtalk, or
            Deskthority (though Reddit threads will suffice). KeycapLendar is <span className="bold">not</span> a place
            to IC, it is a tracker of ICs and GBs. There is also a minimum requirement of a render/photograph of the
            keycaps on a board. This is to ensure a consistent look across the site.
          </Typography>
          <Typography use="headline5" tag="h2">
            Edit
          </Typography>
        ...
        <Card className="guide">
          ...
          <Typography use="caption" tag="p" className="secondary">
            This can include a suffix such as “r2” if it is a revision, using lowercase <span className="code">r</span>{" "}
            to avoid confusion with SA R3.
          </Typography>
          <Typography use="headline5" tag="h2">
            Designer*
          </Typography>
          ...
          <Typography use="body2" tag="p">
            The date of the first IC, in ISO 8601 format (<span className="code">YYYY-MM-DD</span>). This ideally should
            be when the Geekhack/Keebtalk IC was posted, or when a Reddit thread was posted if there is no GH thread.
          </Typography>
          <Typography use="headline5" tag="h2">
            Details*
          </Typography>
          <Typography use="body2" tag="p">
            The link to the IC/GB info. Geekhack is preferred, but failing that, a Reddit thread or dedicated site such
            as MiTo’s is acceptable.
          </Typography>
          <Typography use="headline5" tag="h2">
            Image*
          </Typography>
          ...
          <Typography use="body2" tag="p">
            ...
            and enter the exact date in the fields given. GB end date is not mandatory, but should be added once known.
          </Typography>
          <Typography use="caption" tag="p" className="secondary">
          ...
          <Typography use="caption" tag="p" className="secondary">
            If the vendor is covering multiple regions, separate each region with a comma. If a single vendor covers all
            regions, then enter “Global”. Common regions are listed below.
          </Typography>
          ...
          <Typography use="caption" tag="p" className="secondary">
            <sup>†</sup>Unless there are separate vendors for these regions, such as proto[Typist] and MyKeyboard on the
            same set.
          </Typography>
          <Typography use="caption" tag="p" className="secondary">
