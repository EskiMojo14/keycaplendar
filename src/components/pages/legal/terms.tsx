    ...
    <div className="legal-container">
      <Card className="legal">
        ...
        <Typography use="body2" tag="p">
          ...
          inability to use the materials on KeycapLendar&apos;s website, even if
          KeycapLendar or a KeycapLendar authorised representative has been
        ...
        <Typography use="body2" tag="p">
          ...
          complete or current. KeycapLendar may make changes to the materials
