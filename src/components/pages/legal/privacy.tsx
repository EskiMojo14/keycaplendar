    ...
    <div className="legal-container">
      <Card className="legal">
        <Typography tag="p" use="body2">
          Your privacy is important to us. It is KeycapLendar&apos;s policy to
          ...
          across our website,{" "}
          <a href="https://keycaplendar.firebaseapp.com/">
            https://keycaplendar.firebaseapp.com/
          </a>
          , and other sites we own and operate.
        </Typography>
        <Typography tag="p" use="body2">
          This policy is effective as of 13 April 2021 and was last updated on
          13 April 2021.
        </Typography>
        ...
        <Typography tag="p" use="body2">
          You have the right to have your personal information erased at any
          time, and the site allows you to do this. You can also contact us to
          make sure all information is removed.
        </Typography>
