    ...
    <div className="legal-container">
      <Card className="legal">
        <Typography use="body2" tag="p">
          Your privacy is important to us. It is KeycapLendar&apos;s policy to respect your privacy and comply with any
          applicable law and regulation regarding any personal information we may collect about you, including across
          our website, <a href="https://keycaplendar.firebaseapp.com/">https://keycaplendar.firebaseapp.com/</a>, and
