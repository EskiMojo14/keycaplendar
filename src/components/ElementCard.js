...
export class ElementCard extends React.Component {
    ...
    render() {
        const editIcon = (this.props.admin ? (
            <CardActionIcons>
                <Tooltip content="Edit" align="bottom">
                    <div>
                        <Ripple unbounded>
                            <div className='svg-container' onClick={() => this.props.edit(this.props.set)}>
        ...
        const storeLink = (!this.props.store || this.props.store === '' ? '' : <a href={this.props.store} target="_blank" rel="noopener noreferrer"><CardActionButton>Store</CardActionButton></a>)
        return (
