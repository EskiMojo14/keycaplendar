...
export const PrivacyPolicy = () => {
  return [
    ...
    <div className="legal-container" key="LegalContainer">
      <Card className="legal">
        <Typography use="body2" tag="p">
          Your privacy is important to us. It is KeycapLendar's policy to respect your privacy regarding any information
          we may collect from you across our website,{" "}
          <a href="http://keycaplendar.firebaseapp.com">http://keycaplendar.firebaseapp.com</a>, and other sites we own
          and operate.
        </Typography>
        <Typography use="body2" tag="p">
      ...
      <Card className="legal">
        ...
        <Typography use="body2" tag="ol" type="a">
          <Typography use="body2" tag="li">
            ...
            KeycapLendar's website for personal, non-commercial transitory viewing only. This is the grant of a licence,
        ...
        <Typography use="body2" tag="ol" type="a">
          <Typography use="body2" tag="li">
            The materials on KeycapLendar's website are provided on an 'as is' basis. KeycapLendar makes no warranties,
        ...
        <Typography use="body2" tag="p">
          ...
          use the materials on KeycapLendar's website, even if KeycapLendar or a KeycapLendar authorised representative
