...
import './DrawerCreate.scss';

export class DrawerCreate extends React.Component {
    render() {
        return (
            <Drawer modal open={this.props.open} onClose={this.props.closeCreateDrawer} className="create-drawer drawer-right">
                <DrawerHeader>
                ...
                <div className="drawer-footer">
                    <Button label="Save" onClick={this.props.closeCreateDrawer}/>
                </div>
            </Drawer>
        );
    }
