    ...
    render() {
        ...
        return (
                ...
                {sets.map((set, index) => {
                    ...
                    return (
                        <ElementCard title={title} subtitle={subtitle} image={set.image} details={set.details} store={set.storeLink} admin={this.props.admin} edit={this.props.edit} key={index}/>
                    )
                })}
            </GridInner>
        );
