      ...
      <div>
        ...
        <div className="legal-container">
          <div className="legal">
            ...
            <Typography use="body2" tag="p">
              By accessing the website at <a href="http://keycaplendar.com">http://keycaplendar.com</a>, you are
            ...
            <Typography use="body2" tag="ol" type="a">
              ...
              <Typography use="body2" tag="li">
                ...
                terminated by KeycapLendar at any time. Upon terminating your viewing of these materials or upon the
                termination of this licence, you must destroy any downloaded materials in your possession whether in
            ...
            <Typography use="body2" tag="p">
              ...
              to use the materials on KeycapLendar's website, even if KeycapLendar or a KeycapLendar authorised
            ...
            <Typography use="body2" tag="p">
              ...
              current. KeycapLendar may make changes to the materials contained on its website at any time without
              notice. However KeycapLendar does not make any commitment to update the materials.
            </Typography>
            <Typography use="headline5">6. Links</Typography>
            <Typography use="body2" tag="p">
              KeycapLendar has not reviewed all of the sites linked to its website and is not responsible for the
              contents of any such linked site. The inclusion of any link does not imply endorsement by KeycapLendar of
