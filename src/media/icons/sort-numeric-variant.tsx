...
const SvgSortNumericVariant = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
...
const MemoSvgSortNumericVariant = memo(SvgSortNumericVariant);
export default MemoSvgSortNumericVariant;
