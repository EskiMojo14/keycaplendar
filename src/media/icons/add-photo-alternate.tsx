...
const SvgAddPhotoAlternate = (props: React.SVGProps<SVGSVGElement>) => (
  <svg
...
const MemoSvgAddPhotoAlternate = memo(SvgAddPhotoAlternate);
export default MemoSvgAddPhotoAlternate;
